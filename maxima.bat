...
set lisp=gcl
set version=5.31.2
set prefix=C:\PROGRA~1\MAXIMA~1.2
set maxima_prefix=C:\PROGRA~1\MAXIMA~1.2
set package=maxima
set verbose=false
set mingw_gccver=3.3.1
set path=%maxima_prefix%\gnuplot\bin;%maxima_prefix%\bin;%maxima_prefix%\lib\gcc-lib\mingw32\3.3.1;%path%

if "%USERPROFILE%" == "" goto win9x
if "%MAXIMA_USERDIR%" == "" set MAXIMA_USERDIR=%USERPROFILE%\My Documents\maxima
if "%MAXIMA_TEMPDIR%" == "" set MAXIMA_TEMPDIR=%USERPROFILE%
goto startparseargs
:win9x
if "%MAXIMA_USERDIR%" == "" set MAXIMA_USERDIR=%USER%\user
